...
export const Settings: React.FC = () => {
  ...
  const [activeTab, setActiveTab] = useState<'inference' | 'vector' | 'preferences'>('inference');
            ...
            <button
              ...
              className={`w-full text-left px-3.5 py-2.5 rounded-xl font-bold text-xs flex items-center gap-2.5 transition-all cursor-pointer ${
                activeTab === 'inference'
                  ...
                  : 'text-slate-500 dark:text-zinc-400 hover:bg-slate-50 dark:hover:bg-zinc-950'
              }`}
            >
              <Cpu size={16} />
              AI Inference Server
